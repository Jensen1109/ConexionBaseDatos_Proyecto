...
<%@ page import="java.util.List, modelos.Categoria, modelos.Usuario" %>
<%
    ...
    request.setAttribute("_paginaActiva", "registrarProducto");
%>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Registrar Producto — Tienda Don Pedro</title>
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-submit {
            padding: 0.7rem 2rem; background: #22c55e; color: #fff;
    ...
    <main class="main">
        <div class="card">
            <div class="card__header">
                ...
                <p class="card__subtitle">Complete los datos para agregar un nuevo producto al catálogo.</p>
            </div>
            ...
            <form class="form" action="${pageContext.request.contextPath}/ProductoControlador"
                ...
                <div class="form__group">
                    ...
                    <div class="img-upload-box" id="uploadBox">
                        ...
                        <div class="upload-text">Haz clic o arrastra una imagen</div>
                        <div class="upload-hint">JPG, PNG, WEBP — máx. 5 MB</div>
                ...
                <div class="form__group">
                    ...
                    <input type="text" id="nombre" name="nombre" class="form__input"
                           placeholder="Ej: Arroz Diana 500g" maxlength="80"
                ...
                <div class="form__group">
                    <label class="form__label" for="descripcion">Descripción
                        <span id="cntDesc" style="font-weight:400;color:#94a3b8;font-size:0.72rem;margin-left:0.4rem;">0 / 150</span>
                    </label>
                    <textarea id="descripcion" name="descripcion" class="form__textarea"
                              placeholder="Descripción breve del producto..."
                              maxlength="150" oninput="prContarDesc(this)"></textarea>
